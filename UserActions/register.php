...
$confirmaParola = trim(['confirmPass']);
...
<div class="relative flex flex-col justify-center items-center cen bg-greyTransparent w-96 mt-32 rounded-lg">
    ...
    <form method="post" class="flex flex-col mt-14 w-3/4">
        ...
        <input type="password" name="password" id="password"
               class=" rounded-sm h-10 p-2 bg-netflixGrey border-none mb-2 w-full">
    ...
    <div class="text-gray-600 mb-10 mt-5">Ai deja un cont?   <a href="../UserActions/login.php" class="decoration-0 text-white ml-1">  Inregistreaza-te</a>
    </div>
